...
namespace NSJSBase
{
	...
	public:
		 ...
		 */
		static bool generateSnapshot(const std::string& script, const std::wstring& snapshotPath){return false;};
		 ...
		 */
		JSSmart<CJSValue> runScript(const std::string& script, JSSmart<CJSTryCatch> exception = nullptr, const std::wstring& scriptPath = std::wstring(L"")){return nullptr;};
		/**
		 ...
		 */
		JSSmart<CJSValue> JSON_Parse(const char* json_content){return nullptr;};
		/**
		 ...
		 */
		std::string JSON_Stringify(JSSmart<CJSValue> value){return "";};
		/**
	...
	public:
		 ...
		 */
		static CJSValue* createUndefined(){return nullptr;};
		/**
		 * Creates and returns null JS value in current context.
		 */
		static CJSValue* createNull(){return nullptr;};
		/**
		 * Creates and returns a boolean JS value in current context.
		 * @param value The boolean value.
		 */
		static CJSValue* createBool(const bool& value){return nullptr;};
		/**
		 * Creates and returns an integer JS value in current context.
		 * @param value The integer value.
		 */
		static CJSValue* createInt(const int& value){return nullptr;};
		/**
		 * Creates and returns an unsigned integer JS value in current context.
		 * @param value The unsigned integer value.
		 */
		static CJSValue* createUInt(const unsigned int& value){return nullptr;};
		/**
		 * Creates and returns a double JS value in current context.
		 * @param value The double value.
		 */
		static CJSValue* createDouble(const double& value){return nullptr;};
		/**
		 ...
		 */
		static CJSValue* createString(const char* value, const int& length = -1){return nullptr;};
		/**
		 * Creates and returns a JS string in current context.
		 * @param value The pointer to a null terminated wchar_t array.
		 * @param length The length of a created string. By default the whole string will be created.
		 */
		static CJSValue* createString(const wchar_t* value, const int& length = -1){return nullptr;};
		/**
		 * Creates and returns a JS string in current context.
		 * @param value The ASCII string.
		 */
		static CJSValue* createString(const std::string& value){return nullptr;};
		/**
		 * Creates and returns a JS string in current context.
		 * @param value The wchar string.
		 */
		static CJSValue* createString(const std::wstring& value){return nullptr;};

		/**
		 * Creates and returns an empty JS object in current context.
		 */
		static CJSObject* createObject(){return nullptr;};

		/**
		 * Creates and returns a JS array of specified length in current context.
		 * @param count The length of an array.
		 */
		static CJSArray* createArray(const int& count){return nullptr;};
	...
	public:
		 ...
		 */
		static JSSmart<CJSContext> GetCurrent(){return nullptr;};
	...
	public:
		 ...
		 */
		static bool IsSupportNativeTypedArrays(){return false;};
	};
